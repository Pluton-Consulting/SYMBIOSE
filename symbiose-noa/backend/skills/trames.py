...
SKILLS = {
    ...
    "reproduire_document": Declaration(
        ...
        description=(
            ...
            "« fais un memoire (un devis, un courrier) EN PARTANT d'un exemple / d'un "
            "ancien / sur le modele de » : c'est LUI, pas `produire_document` ni "
            "`creer_document`, qui repartent de ZERO et perdent tout le contenu de "
            "l'exemple (15/09 : un memoire de 205 Ko reecrit en une page de titres). "
