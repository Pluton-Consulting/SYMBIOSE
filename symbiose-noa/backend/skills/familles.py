...
FAMILLES: dict[str, tuple[str, ...]] = {
    ...
    "stockage": ("ou_chercher", "inventaire_dossier",
                 ...
                 "drive_deposer_document", "drive_creer_dossier",
    ...
    "donnees": ("interroger_donnees", "liste_clients", "liste_fournisseurs", "fiche_client",
                "dossiers_en_attente", "prix_observes", "chiffre_affaires", "articles_frequents",
                "pieces_du_client", "frequence_des_passages"),
    ...
    "visuels": ("preparer_visuel", "tester_visuel", "generer_visuel", "modifier_visuel", "pivoter_image",
                "convertir_image", "composer_visuel"),
