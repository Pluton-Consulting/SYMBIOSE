...
async def produire(titre: str, blocs: list, proprietaire: str,
    ...
    return {
        ...
        "note": (f"Le document est TERMINÉ : {pages or '?'} page(s) estimées, "
                 ...
                 "pour ce fichier et n'invente jamais son adresse. Ta "
                 "réponse : UNE ou deux phrases sur le CONTENU. Ne cite "
                 "JAMAIS le document_id ni les compteurs (éléments, octets, "
                 "pages) : la carte porte déjà tout cela. Ne produis "
