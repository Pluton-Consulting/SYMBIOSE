...
ACTES = {
    ...
    "mon_agenda": "je regarde l'agenda",
    "creneaux_agenda": "je cherche un créneau libre",
    "creer_rendez_vous": "je pose le rendez-vous",
    "lire_mail": "j'ouvre le message",
    "lire_piece_jointe": "je lis la pièce jointe",
    "boites_mail": "je liste les boîtes mail",
    "preparer_envois": "je prépare les cartes d’envoi",
    ...
    "suspendre_tache": "je mets la tâche en pause",
