...
PAR_SKILL: dict[str, list[str]] = {
    ...
    # « Joins le devis » sous un refus poli (11/09) : une suite sans rapport.
    "redaction_email":      ["Mets-le dans mes brouillons",
                             "Fais-en une version plus courte",
                             "Envoie-le"],
    "deposer_brouillon":    ["Envoie-le",
    ...
    "drive_apercu":         ["Liste les fichiers de ce dossier", "Ouvre-le en entier"],
    "drive_lister":         ["Ouvre le plus récent", "Résume-moi ce dossier"],
