...
export function EmailCard({
  ...
  return (
    <div style={{ background: "var(--marque-surface)", border: "1px solid var(--marque-border)", borderLeft: "4px solid var(--marque-primary-mid)", borderRadius: "var(--marque-radius-card-sm)", boxShadow: "var(--marque-shadow-card)", padding: "13px 15px", maxWidth: "min(var(--bloc-largeur), 100%)" }}>
      ...
      <div style={{ fontSize: 12.5, color: "var(--marque-text-body)", lineHeight: 1.5 }}>{md(preview)}</div>
    </div>
  )
}
