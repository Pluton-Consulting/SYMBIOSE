...
export function RichText({ children }: { children?: ReactNode }) {
  return (
    <p style={{ margin: 0, fontSize: 14.5, lineHeight: 1.65, color: "var(--color-text-body)" }}>
      {children ?? (
        <>
...
export const B = ({ children }: { children: ReactNode }) => <strong style={{ fontWeight: 700, color: "var(--color-text-primary)" }}>{children}</strong>
...
export const Accent = ({ children }: { children: ReactNode }) => <span style={{ color: "var(--color-primary-mid)", fontWeight: 600 }}>{children}</span>
export const Muted = ({ children }: { children: ReactNode }) => <span style={{ color: "var(--color-text-muted)" }}>{children}</span>
