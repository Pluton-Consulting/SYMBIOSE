...
function renderBlock(block: any, onAction?: (v: string) => void,
  ...
  switch (type) {
    ...
    case "visuel":        return <VisuelPaysager titre={p.titre} images={p.images} principale={p.principale} genereParIA={p.genere_par_ia === true} apiUrl={acces?.apiUrl} backendToken={acces?.backendToken} />
